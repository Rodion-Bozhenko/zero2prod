...
async fn subscribe_returns_a_200_for_valid_form_data() {
    ...
    let body = "name=porqe%20maria&email=porqe_maria%40gmail.com";
    ...
    assert_eq!(saved.email, "porqe_maria@gmail.com");
    assert_eq!(saved.name, "porqe maria");
}
...
async fn subscribe_returns_a_400_when_form_data_is_missing() {
    ...
    let test_cases = vec![
        ("name=porqe%20maria", "missing the email"),
        ("email=porqe_maria%40gmail.com", "missing the name"),
